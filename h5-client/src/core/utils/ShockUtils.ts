...
class ShockUtils extends BaseClass {
    ...
    private mapPoss:Array<any> = [new egret.Point(0, 5), new egret.Point(0, 0), new egret.Point(0, -5)];
    private spritePoss:Array<any> = [new egret.Point(-5, -5),new egret.Point(5, -5), new egret.Point(0, 0), new egret.Point(-5, 5), new egret.Point(5, 5)];
