...
class App {
    ...
    public static IsNetAvaliable():boolean {
    ...
    public static get MsgFactory(): MsgFactory {
    ...
    public static Init():void {
        ...
        App.Socket.initServer(App.GlobalData.SocketServer, App.GlobalData.SocketPort, App.GlobalData.SocketUrl, new ByteArrayMsgByProtobuf());
    }
}
