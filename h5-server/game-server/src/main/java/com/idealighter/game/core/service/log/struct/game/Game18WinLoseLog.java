...
public class Game18WinLoseLog extends GameWinLoseLog {
  /**
   * 构造函数.
   * 
   * @param player 玩家.
   ...
   * @param reason .
   */
  public Game18WinLoseLog(Player player, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
   ...
   * @param reason .
   */
  public Game18WinLoseLog(PlayerBo domain, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
