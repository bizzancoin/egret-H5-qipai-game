...
import com.idealighter.game.games.bairenniuniu.message.ReqExchangeGoldsMsg;
import com.idealighter.game.message.ModuleMsgIdConstant;
import com.idealighter.game.message.core.ReqMessage;
import com.idealighter.game.message.core.ResMessage;
import com.idealighter.game.server.handler.ReqMessageHandler;

@ReqMsgHandler(ModuleMsgIdConstant.BaiRenNiuNiu.EXCHANGE_GOLDS)
public class ReqExchangeGoldsHandler implements ReqMessageHandler {
  ...
  public ResMessage action(Player player, ReqMessage message) {
    ...
    return baiRenMgr.exchangeGold(player, msg.getChips());
