...
@ReqMsgHandler(ModuleMsgIdConstant.BaiRenNiuNiu.CLEAR_BET)
public class ReqClearBetHandler implements ReqMessageHandler {
  ...
  public ResMessage action(Player player, ReqMessage message) {
    // ReqClearBetMsg msg = (ReqClearBetMsg)message;
    return baiRenMgr.clearBet(player);
  }
}
