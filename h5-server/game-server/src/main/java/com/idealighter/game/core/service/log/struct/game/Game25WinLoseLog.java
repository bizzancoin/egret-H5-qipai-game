...
public class Game25WinLoseLog extends GameWinLoseLog {
   ...
   * @param reason .
   */
  public Game25WinLoseLog(Player player, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
   ...
   * @param reason .
   */
  public Game25WinLoseLog(PlayerBo domain, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
