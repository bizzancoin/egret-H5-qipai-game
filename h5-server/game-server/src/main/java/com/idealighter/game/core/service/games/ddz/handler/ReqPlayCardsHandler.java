...
import com.idealighter.game.games.ddz.message.ReqPlayCardsMsg;
...
@ReqMsgHandler(ModuleMsgIdConstant.DDZ.PLAY_CARD)
public class ReqPlayCardsHandler implements ReqMessageHandler {
  ...
  public ResMessage action(Player player, ReqMessage message) {
    ReqPlayCardsMsg msg = (ReqPlayCardsMsg) message;
    return ddzMgr.playCards(player, msg.getCards());
  }
}
