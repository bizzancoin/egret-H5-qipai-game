...
@ReqMsgHandler(ModuleMsgIdConstant.DDZ.PROMPT)
public class ReqPromptHandler implements ReqMessageHandler {
  ...
  public ResMessage action(Player player, ReqMessage message) {
    // ReqPromptMsg msg = (ReqPromptMsg) message;
    return ddzMgr.prompt(player);
  }
}
