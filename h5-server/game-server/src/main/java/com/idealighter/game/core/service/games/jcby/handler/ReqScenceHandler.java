...
@ReqMsgHandler(ModuleMsgIdConstant.Jcby.SCREEN)
public class ReqScenceHandler implements ReqMessageHandler {
  ...
  public ResMessage action(Player player, ReqMessage message) {
    // ReqScenceMsg msg = (ReqScenceMsg)message;
    return jcbyMgr.sendScenceData(player);
  }
}
