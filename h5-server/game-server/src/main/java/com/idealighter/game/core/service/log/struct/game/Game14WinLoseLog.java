 ...
 * 通比牛牛输赢日志 .
 * 
 * @date 2015年02月17日 上午11:01:14
 *
 */
@LogTable(type = TableType.DAY)
public class Game14WinLoseLog extends GameWinLoseLog {
  /**
   * 构造函数.
   * 
   * @param player 玩家.
   ...
   * @param reason .
   */
  public Game14WinLoseLog(Player player, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
   ...
   * @param reason .
   */
  public Game14WinLoseLog(PlayerBo domain, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
