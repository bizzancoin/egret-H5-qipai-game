...
public class IngotLog extends PlayerLog {
   ...
   * @param reason .
   */
  public IngotLog(Player player, long before, long after, LogReason reason) {
    super(player);
    this.before = before;
    this.after = after;
   ...
   * @param reason .
   */
  public IngotLog(PlayerBo domain, long before, long after, LogReason reason) {
    super(domain);
    this.before = before;
    this.after = after;
    this.change = after - before;
