 ...
 * 积分日志.
 * 
 * @date 2015年9月1日 上午10:30:04
 *
 */
@LogTable(type = TableType.DAY)
public class CreditLog extends PlayerLog {
   ...
   * @param reason .
   */
  public CreditLog(Player player, long before, long after, LogReason reason) {
    super(player);
    this.before = before;
    this.after = after;
   ...
   * @param reason .
   */
  public CreditLog(PlayerBo domain, long before, long after, LogReason reason) {
    super(domain);
    this.before = before;
    this.after = after;
    this.change = after - before;
