...
import com.idealighter.game.core.dao.generate.domain.PlayerStatusRecordDomainExample.Criteria;
import com.idealighter.game.core.dao.generate.domain.PlayerStatusRecordDomainExample.Criterion;
import com.idealighter.game.core.dao.generate.domain.PlayerStatusRecordDomainExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PlayerStatusRecordDomainSqlProvider {
     ...
     */
    public String countByExample(PlayerStatusRecordDomainExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("player_status_record");
     ...
     * @mbg.generated Tue Aug 14 14:13:21 CST 2018
     */
    public String deleteByExample(PlayerStatusRecordDomainExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("player_status_record");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Tue Aug 14 14:13:21 CST 2018
     */
    public String insertSelective(PlayerStatusRecordDomain record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("player_status_record");
        ...
        if (record.getGametime() != null) {
            sql.VALUES("gametime", "#{gametime,jdbcType=BIGINT}");
        }
        
        if (record.getOnlinetime() != null) {
            sql.VALUES("onlinetime", "#{onlinetime,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated Tue Aug 14 14:13:21 CST 2018
     */
    public String selectByExample(PlayerStatusRecordDomainExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("gametime");
        sql.SELECT("onlinetime");
        sql.SELECT("update_time");
        sql.FROM("player_status_record");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PlayerStatusRecordDomain record = (PlayerStatusRecordDomain) parameter.get("record");
        PlayerStatusRecordDomainExample example = (PlayerStatusRecordDomainExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("player_status_record");
        ...
        if (record.getGametime() != null) {
            sql.SET("gametime = #{record.gametime,jdbcType=BIGINT}");
        }
        
        if (record.getOnlinetime() != null) {
            sql.SET("onlinetime = #{record.onlinetime,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated Tue Aug 14 14:13:21 CST 2018
     */
    public String updateByPrimaryKeySelective(PlayerStatusRecordDomain record) {
        SQL sql = new SQL();
        sql.UPDATE("player_status_record");
        ...
        if (record.getLogoutTime() != null) {
            sql.SET("logout_time = #{logoutTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getGametime() != null) {
            sql.SET("gametime = #{gametime,jdbcType=BIGINT}");
        }
        
        if (record.getOnlinetime() != null) {
            sql.SET("onlinetime = #{onlinetime,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated Tue Aug 14 14:13:21 CST 2018
     */
    protected void applyWhere(SQL sql, PlayerStatusRecordDomainExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
