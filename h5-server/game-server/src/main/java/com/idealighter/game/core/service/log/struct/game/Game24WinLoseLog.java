...
public class Game24WinLoseLog extends GameWinLoseLog {
   ...
   * @param reason .
   */
  public Game24WinLoseLog(Player player, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
   ...
   * @param reason .
   */
  public Game24WinLoseLog(PlayerBo domain, AbstractSeat seat, long chips, long gold,
      LogReason reason) {
