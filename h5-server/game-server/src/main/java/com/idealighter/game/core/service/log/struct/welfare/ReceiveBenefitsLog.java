...
public class ReceiveBenefitsLog extends PlayerLog {

  @Column(type = "bigint", size = 20, remark = "领取前")
  public final long before;
  @Column(type = "bigint", size = 20, remark = "领取后")
   ...
   * @param before .
   */
  public ReceiveBenefitsLog(Player player, long before) {
    super(player);
    this.before = before;
