...
public interface IBaiRenNiuniuService {
  /**
   * 获取房间类型.
   * 
   * @return 房间类型列表.
   ...
   * @return 房间列表.
   */
  ResultPage<BaiRenNiuniuRoomBo> findRoomByPage(Integer page, Integer pageSize);
   ...
   * @param bo 房间实体.
   */
  void saveRoom(BaiRenNiuniuRoomBo bo);
  ...
  List<BaiRenNiuniuRoomBo> findRoom(Byte active);

  BaiRenNiuniuRoomBo findRoomById(Integer roomId);
}
