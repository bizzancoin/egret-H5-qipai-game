 ...
 * @author 
 */
public class FruitslotRoom implements Serializable {
    private Integer id;
    ...
    private Long robotLower;

    private Long robotUpper;
    ...
    public Long getRobotLower() {
        return robotLower;
    }

    public void setRobotLower(Long robotLower) {
        this.robotLower = robotLower;
    }

    public Long getRobotUpper() {
        return robotUpper;
    }

    public void setRobotUpper(Long robotUpper) {
        this.robotUpper = robotUpper;
    }
    ...
    public boolean equals(Object that) {
        ...
        FruitslotRoom other = (FruitslotRoom) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRobotLower() == null ? other.getRobotLower() == null : this.getRobotLower().equals(other.getRobotLower()))
            && (this.getRobotUpper() == null ? other.getRobotUpper() == null : this.getRobotUpper().equals(other.getRobotUpper()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRobotLower() == null) ? 0 : getRobotLower().hashCode());
        result = prime * result + ((getRobotUpper() == null) ? 0 : getRobotUpper().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", robotLower=").append(robotLower);
        sb.append(", robotUpper=").append(robotUpper);
