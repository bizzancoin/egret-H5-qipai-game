 ...
 * @author
 */
public class WknhRoom implements Serializable {
  /**
   * 房间id
   */
  private Integer id;
  ...
  public boolean equals(Object that) {
    ...
    return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
        ...
        && (this.getScences() == null ? other.getScences() == null
            : this.getScences().equals(other.getScences()))
        && (this.getLikui() == null ? other.getLikui() == null
            : this.getLikui().equals(other.getLikui()))
        && (this.getExchangeper() == null ? other.getExchangeper() == null
            : this.getExchangeper().equals(other.getExchangeper()))
        && (this.getPowerbatterymultiple() == null ? other.getPowerbatterymultiple() == null
            : this.getPowerbatterymultiple().equals(other.getPowerbatterymultiple()))
        && (this.getPowerbatterypro() == null ? other.getPowerbatterypro() == null
            : this.getPowerbatterypro().equals(other.getPowerbatterypro()))
        && (this.getPowerbatterytime() == null ? other.getPowerbatterytime() == null
            : this.getPowerbatterytime().equals(other.getPowerbatterytime()))
  ...
  public int hashCode() {
    ...
    result = prime * result
        + ((getPowerbatterymultiple() == null) ? 0 : getPowerbatterymultiple().hashCode());
    result =
        prime * result + ((getPowerbatterypro() == null) ? 0 : getPowerbatterypro().hashCode());
    result =
        prime * result + ((getPowerbatterytime() == null) ? 0 : getPowerbatterytime().hashCode());
