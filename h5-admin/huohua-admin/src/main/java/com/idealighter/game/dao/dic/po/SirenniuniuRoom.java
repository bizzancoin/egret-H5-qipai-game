 ...
 * @author 
 */
public class SirenniuniuRoom implements Serializable {
    private Integer id;
    ...
    public Integer getBaseBet() {
        return baseBet;
    }

    public void setBaseBet(Integer baseBet) {
    ...
    public boolean equals(Object that) {
        ...
        SirenniuniuRoom other = (SirenniuniuRoom) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getBaseBet() == null ? other.getBaseBet() == null : this.getBaseBet().equals(other.getBaseBet()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBaseBet() == null) ? 0 : getBaseBet().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", baseBet=").append(baseBet);
